...
const Berkacamain = () => {
  ...
  useEffect(() => {
    if (sessionStorage.getItem("idkota_berkaca2") !== null) {
      ...
      updatePeta2(
        sessionStorage.getItem("idkota_berkaca2"),
        sessionStorage.getItem("yearss")
      );
  ...
  function getDataSet2() {
    ...
    sessionStorage.setItem(
      ...
      JSON.stringify({
        ...
        dataset_1Berkaca:
          dataSet1.length === 0 ? live_data?.dataset_1Berkaca || [] : dataSet1,
        all_ds1_set:
          ...
          {children.length > 0 && (
            <div>
              <FontAwesomeIcon
                icon={faChevronDown}
                color="white"
                className={`text-right ml-[20px] w-[10px] h-[20px] ${viewChildren && "rotate-180"
                  }`}
              />
            </div>
          )}
  ...
  useEffect(() => {
    const liveData =
      JSON.parse(sessionStorage.getItem("selectedDataBerkaca")) || {};
    setData(liveData);
  }, []);
  ...
  const handleClick = () => {
    ...
    const updatedData = {
      ...
      parent_id_1Berkaca: IDchildFilter,
      dataset_1Berkaca:
        dataSet1.length === 0 || dataSet1 == "semua"
          ? live_data?.dataset_1Berkaca || []
          : dataSet1,
      all_ds1_set:
        ds1_set.length === 0 ? live_data?.all_ds1_set || [] : ds1_set,
      ds2_parent: idParent2,
      ...
      parent_id_2Berkaca: IDchildFilter2,
      dataset_2Berkaca:
        dataSet2.length === 0 || dataSet2 == "semua"
          ? live_data?.dataset_2Berkaca || []
          : dataSet2,
      labelset1:
        labelSet1.length === 0 ? live_data?.labelset1 || [] : labelSet1,
      labelset2: labelSet2,
  ...
  return (
    <div>
      ...
      <div className="flex flex-col mt-[125px] mb-[20px] justify-center items-center">
        ...
        <h1 className="text-center flex justify-center items-center text-secondary text-[24px] md:text-[34px] font-bold mt-[24px] mb-[20px]">
              ...
              <div className="w-[250px] h-auto text-secondary font-medium text-[14px] cursor-pointer">
                ...
                >
                  ...
                  <FontAwesomeIcon
                    icon={faChevronDown}
                    color="#24445A"
                    className={`ml-[20px] w-[10px] h-[20px] ${openProvinsi2 && "rotate-180"
                      }`}
                  />
                </div>
                <div
              ...
              <div className="w-[250px] h-auto text-secondary font-medium text-[14px] cursor-pointer">
                ...
                >
                  ...
                  <FontAwesomeIcon
                    icon={faChevronDown}
                    color="#24445A"
                    className={`ml-[20px] w-[10px] h-[20px] ${openCity2 && "rotate-180"
                      }`}
                  />
                </div>
                <div
        ...
        <div className="w-[140px] h-auto text-secondary font-medium text-[14px] cursor-pointer mt-[40px]">
          ...
          >
            ...
            <FontAwesomeIcon
              icon={faChevronDown}
              color="#24445A"
              className={`ml-[40px] w-[10px] h-[20px] ${openYears && "rotate-180"
                }`}
            />
          </div>
          <ul
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex gap-[40px] mt-[40px] mb-[20px] ml-[40px]">
                  ...
                  <div className="flex gap-[10px]">
                    ...
                    <a
                      href={selected2 ? "/Berkaca-Profil-Daerah2" : "#"}
                      onClick={(e) => !selected2 && e.preventDefault()}
                    >
                      <img
                        src={people}
                        alt=""
      ...
      <div className="flex flex-col mb-[50px]">
          ...
          <div id="dataset1" className="gap-[100px] mt-[40px] h-auto">
            <h1 className="text-secondary text-[14px] font-semibold text-center">
              DATASET 1
            </h1>
            <div>
              {provinsiSelected ? (
                  ...
                  <div className="lg:w-[250px] w-[200px] h-auto rounded-[10px] text-white border-1 border-[f1f1f1] text-[14px] font-medium  drop-shadow-lg mt-[10px] mb-[10px] cursor-pointer ">
                    <div
                      onClick={() => {
                        if (
                          ...
                          Swal.fire({
                            title: "Perhatian!",
                            text: "Kolom Kab/Kota pada Wilayah 2 harus diisi karena tidak memungkinkan perbandingan antara provinsi dan kabupaten.",
                            confirmButtonText: "Tutup",
                            confirmButtonColor: "#24445A",
                            customClass: {
                              icon: "no-border",
                    ...
                    >
                      ...
                      <FontAwesomeIcon
                        icon={faChevronDown}
                        color="white"
                        className={`ml-[20px] w-[10px] h-[20px] ${openParents && "rotate-180"
                          }`}
                      />
                    </div>
                    <ul
                    ...
                    >
                      ...
                      >
                        ...
                        <FontAwesomeIcon
                          icon={faChevronDown}
                          color="white"
                          className={`ml-[20px] w-[10px] h-[20px] ${openSelectFilter && "rotate-180"
                            }`}
                        />
                      </div>
                      <ul
          ...
          <div id="dataset2" className="hidden gap-[100px] mt-[40px] h-auto">
            ...
            <div className="flex flex-row items-center justify-center gap-x-5 mt-5 xl:mr-[100px] lg:mr-[100px] md:mr-[80px] mr-[60px]">
              ...
              <h1 className="text-secondary text-[14px] font-semibold mt-[-6px] lg:mt-0">
                DATASET 2
              </h1>
            </div>
                ...
                <div className="lg:w-[250px] w-[200px] h-auto rounded-[10px] text-white border-1 border-[f1f1f1] text-[14px] font-medium drop-shadow-lg mt-[10px] mb-[10px] cursor-pointer ">
                  ...
                  >
                    ...
                    <FontAwesomeIcon
                      icon={faChevronDown}
                      color="white"
                      className={`ml-[20px] w-[10px] h-[20px] ${openParents2 && "rotate-180"
                        }`}
                    />
                  </div>
                  <ul
                  ...
                  >
                    ...
                    >
                      ...
                      <FontAwesomeIcon
                        icon={faChevronDown}
                        color="white"
                        className={`ml-[20px] w-[10px] h-[20px] ${openSelectFilter2 && "rotate-180"
                          }`}
                      />
                    </div>
                    <ul
                  ...
                  <div id="anakanfilter2" className="hidden w-auto mt-[10px]">
                    <div className="bg-secondary p-[10px] rounded-[10px] text-white max-h-[250px] overflow-y-scroll mini-scrollbar">
                      {Array.isArray(childFilter2) &&
                        childFilter2.length > 0 ? (
                        childFilter2.map((anaknyafilter2, index) =>
                          index == 0 &&
                      ...
                      <div>
                        <button
                          onClick={() => {
                            ...
                            window.location.href = "/Berkaca-Graph-Api";
                          }}
                          className="
                        mt-[25px]
                        flex 
