...
const BerkacaprofileD2 = () => {
  ...
  useEffect(() => {
    if (sessionStorage.getItem("idkota_berkaca2") !== null) {
      updatePeta(sessionStorage.getItem("idkota_berkaca2"));
    }
  }, []);
  ...
  useEffect(() => {
    if (sessionStorage.getItem("idkota_berkaca2") !== null) {
      wilayah = sessionStorage.getItem("idkota_berkaca2");
      updatePejabat(
        sessionStorage.getItem("idkota_berkaca2"),
        sessionStorage.getItem("yearss")
      );
      setWilayahID(sessionStorage.getItem("idkota_berkaca2"));
      if (sessionStorage.getItem("idprovinsi_berkaca2") !== null) {
        provinsi = sessionStorage.getItem("idprovinsi_berkaca2");
        setGetInfoProvinsi(sessionStorage.getItem("idprovinsi_berkaca2"));
        console.log("idprovinsi = " + getInfoProvinsi);
        console.log(
          "idprovinsisession = " + sessionStorage.getItem("idprovinsi_berkaca2")
        );
        console.log("provinsi = " + provinsi);
        sessionStorage.setItem(
          "Berkacaprofil2_provinsi",
          sessionStorage.getItem("idprovinsi_berkaca2")
        );
      }
    }
            ...
            {provincess?.map((provinces) => (
              <li
                ...
                onClick={() => {
                  ...
                  updatePejabat(
                    sessionStorage.getItem("Berkacaprofil2_provinsi"),
                    selectedYears
                  );
                  updateDPRD(
                    sessionStorage.getItem("Berkacaprofil2_provinsi"),
                  ...
                  sessionStorage.setItem("idprovinsi_berkaca2", provinces.id);
                  sessionStorage.setItem(
                    "namaprovinsi_berkaca2",
                    provinces.nama
                  );
                  sessionStorage.setItem("idprovinsi_berkaca2", provinces.id);
                  sessionStorage.setItem("namaprovinsi_berkaca2", provinces.nama);
                  sessionStorage.setItem("namawilayah_berkaca2", "Semua");
                  sessionStorage.setItem("namakota_berkaca2", "Semua");
                  sessionStorage.setItem("idkota_berkaca2", provinces.id);
                }}
              >
                {provinces?.nama}
              </li>
          ...
          >
            <li
              ...
              onClick={() => {
                ...
                updatePeta(sessionStorage.getItem("Berkacaprofil2_provinsi"));
                setOpenCity(false);
                askIsProvince(true);
                updatePejabat(
                  sessionStorage.getItem("Berkacaprofil2_provinsi"),
              ...
              <li
                ...
                onClick={() => {
                  if (
                    ...
                    sessionStorage.setItem("namawilayah_berkaca2", regencies.nama);
                    sessionStorage.setItem("idkota_berkaca2", regencies.id);
                    sessionStorage.setItem("namakota_berkaca2", regencies.nama);
                  }
                }}
              >
                {regencies?.nama}
...
export default BerkacaprofileD2;
