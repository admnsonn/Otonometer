...
const BerkacaTimeseries = () => {
  ...
  }, [selectedCityDaerah1, selectedCityDaerah2, selectedDaerah1, prevSelectedProvince, prevSelectedCity]);
  ...
  function GrafikD2() {
    ...
    return (
      <section>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4 md:gap-x-8 md:gap-y-8 mt-8 sm:mt-16 mt-[50px] sm:ml-4 mx-auto">
          {/* DATASET1 DAERAH 1 */}
          <div
    ...
    <div className="flex flex-col mt-[100px] mb-[150px] justify-center items-center">
            ...
            {provincessDaerah2?.map((provinces2) => (
              <li
                ...
                if(sessionStorage.getItem("namawilayah") === "Semua"){
                    ...
                    setIsProvinceDaerah2(true);
                }else if(sessionStorage.getItem("namawilayah") !== "Semua"){
                    updateKotaDaerah2(
                      provinces2?.nama,
                      selectedDaerah2,
                      provinces2.id
                    ...
                    sessionStorage.setItem("idprovinsi_berkaca2", provinces2.id);
                    sessionStorage.setItem("namaprovinsi_berkaca2",provinces2.nama);
                    console.log(sessionStorage.getItem("idwilayah_berkaca2"))
                    setIsModalOpen2(true);
                    setSelectedCityDaerah1("Semua");
                    sessionStorage.setItem("namawilayah", "Semua");
            ...
            <NavLink
              ...
              onClick={(e) => {
                if (
                  ...
                  Swal.fire({
                    title: "Perhatian!",
                    text: "Silahkan pilih Kab/Kota pada Wilayah 2 karena tidak memungkinkan perbandingan antara Provinsi dan Kab/Kota",
                    confirmButtonText: "Tutup",
      ...
      <div id="timeseriesnyaaaaaaa2">
        <div className="flex flex-col justify-center items-center  ">
          ...
          <div className="lg:hidden md:hidden">{GrafikD2()}</div>
          <div
            className={activeTabMobileDataset === "dataset1" ? "" : "hidden"}
          >
        ...
        <div className="flex items-center gap-[10px]">
            <div className="w-[30px] h-[30px] md:w-[40px] md:h-[40px] rounded-md bg-primary drop-shadow-lg flex justify-center items-center hover:bg-third cursor-pointer" onClick={() => SimpanHalamanSemua(halaman_timeseries)}>
        ...
        <div className="text-center mt-4">
          <button
           onClick={() => {
            ...
            setInfoDaerah2("Semua");
            setSelectedCityDaerah2("Semua");
            setGetInfoProvinsiDaerah2(sessionStorage.getItem("idwilayah_berkaca2"));
            setWilayahIDDaerah2(sessionStorage.getItem("idwilayah_berkaca2"));
            setIsProvinceDaerah2(true); 
            console.log(sessionStorage.getItem("idwilayah_berkaca2"))
          }}
