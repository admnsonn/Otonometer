...
import { faChevronDown, faDownload, faEye, faSearch, faSearchLocation, faFilePdf, faShare, faBookBookmark } from "@fortawesome/free-solid-svg-icons";
...
const BerkacaTimeseries = () => {
  ...
  const [selectedDaerah1, setSelectedDaerah1] = useState(sessionStorage.getItem("namaprovinsi"));
  ...
  const [getInfoProvinsiDaerah1, setGetInfoProvinsiDaerah1] = useState(sessionStorage.getItem("idprovinsi"));
  const [wilayahIDDaerah1, setWilayahIDDaerah1] = useState(sessionStorage.getItem("idwilayah"));
  ...
  const [selectedDaerah2, setSelectedDaerah2] = useState(sessionStorage.getItem("namaprovinsi_berkaca2"));
  ...
  const [getInfoProvinsiDaerah2, setGetInfoProvinsiDaerah2] = useState(sessionStorage.getItem("idprovinsi_berkaca2"));
  const [wilayahIDDaerah2, setWilayahIDDaerah2] = useState(sessionStorage.getItem("idwilayah_berkaca2"));
  ...
  const [selectedCityDaerah1, setSelectedCityDaerah1] = useState(sessionStorage.getItem("namakota"));
  ...
  const [selectedCityDaerah2, setSelectedCityDaerah2] = useState(sessionStorage.getItem("namakota_berkaca2"));
  ...
  function updateDaerah1(wilayah_id) {
    fetch(process.env.REACT_APP_URL_API + "/wilayah-info?lang=en&wilayah_id=" + wilayah_id + "&tahun=" + sessionStorage.getItem("yearss"), requestOptions)
      .then((response) => response.json())
      .then((result) => {
  ...
  const { parent_id_1Berkaca, dataset_1Berkaca, parent_id_2Berkaca, dataset_2Berkaca, LabelnyaTimeseries_1, LabelnyaTimeseries_2 } = selectedDataBerkaca;
  ...
  const [view_info_halaman_timeseries, setView_info_halaman_timeseries] = useState(0);
  const [like_info_halaman_timeseries, setLike_info_halaman_timeseries] = useState(0);
  const [simpan_info_halaman_timeseries, setSimpan_info_halaman_timeseries] = useState(0);
  ...
  useEffect(() => {
    if (dataset_1Berkaca.length !== 0 && dataset_2Berkaca.length !== 0 && wilayahIDDaerah1 !== null && !isModalOpen && !isModalOpen3) {
      if (wilayahIDDerahSATU == "Semua" && selectedCityDaerah2 != "Semua") {
        // return;
      } else if (wilayahIDDerahSATU != "Semua" && selectedCityDaerah2 == "Semua") {
        // return;
      } else {
        var urls = process.env.REACT_APP_URL_API + "/berkaca?tahun=semua&&wilayah=[" + wilayahIDDaerah1 + "," + wilayahIDDaerah2 + "]";
        if (typeof dataset_1Berkaca !== "string") {
          urls += "&dataset_1=[" + dataset_1Berkaca + "]&parent_id_1=" + parent_id_1Berkaca;
        } else {
          urls += "&dataset_1=" + dataset_1Berkaca + "&parent_id_1=" + parent_id_1Berkaca;
            ...
            Object.keys(data.data.dataset_1).forEach((item) => {
              data.data.dataset_1[item].forEach((list) => {
                if (list.id_wilayah == wilayahIDDaerah1) {
                  if (tahun["" + list.label] == null) {
                    var lokalData = list;
                    lokalData[LabelnyaTimeseries_1[list.id_bidang]] = convertToNumber(lokalData.label_nilai);
                    tahun["" + list.label] = lokalData;
                  } else {
                    var lokalData = tahun["" + list.label];
                    lokalData[LabelnyaTimeseries_1[list.id_bidang]] = convertToNumber(list.label_nilai);
                    tahun["" + list.label] = lokalData;
                  }
                }
              });
            ...
            Object.keys(data.data.dataset_2).forEach((item) => {
              data.data.dataset_2[item].forEach((list) => {
                if (list.id_wilayah == wilayahIDDaerah1) {
                  if (tahun2["" + list.label] == null) {
                    var lokalData = list;
                    lokalData[LabelnyaTimeseries_2[list.id_bidang]] = convertToNumber(lokalData.label_nilai);
                    tahun2["" + list.label] = lokalData;
                  } else {
                    var lokalData = tahun2["" + list.label];
                    lokalData[LabelnyaTimeseries_2[list.id_bidang]] = convertToNumber(list.label_nilai);
                    tahun2["" + list.label] = lokalData;
                  }
                }
              });
  ...
  useEffect(() => {
    if (dataset_1Berkaca.length !== 0 && dataset_2Berkaca.length !== 0 && wilayahIDDaerah2 !== null && !isModalOpen2 && !isModalOpen4) {
      if (wilayahIDDerahSATU == "Semua" && selectedCityDaerah2 != "Semua") {
        // return;
      } else if (wilayahIDDerahSATU != "Semua" && selectedCityDaerah2 == "Semua") {
        // return;
            ...
            Object.keys(data.data.dataset_1).forEach((item) => {
              data.data.dataset_1[item].forEach((list) => {
                if (list.id_wilayah == wilayahIDDaerah2) {
                  if (tahunD2["" + list.label] == null) {
                    var lokalDataD2 = list;
                    lokalDataD2[LabelnyaTimeseries_1[list.id_bidang]] = convertToNumber(lokalDataD2.label_nilai);
                    tahunD2["" + list.label] = lokalDataD2;
                  } else {
                    var lokalDataD2 = tahunD2["" + list.label];
                    lokalDataD2[LabelnyaTimeseries_1[list.id_bidang]] = convertToNumber(list.label_nilai);
                    tahunD2["" + list.label] = lokalDataD2;
                  }
                }
              });
            ...
            Object.keys(data.data.dataset_2).forEach((item) => {
              data.data.dataset_2[item].forEach((list) => {
                if (list.id_wilayah == wilayahIDDaerah2) {
                  if (tahun2D2["" + list.label] == null) {
                    var lokalDataD2 = list;
                    lokalDataD2[LabelnyaTimeseries_2[list.id_bidang]] = convertToNumber(lokalDataD2.label_nilai);
                    tahun2D2["" + list.label] = lokalDataD2;
                  } else {
                    var lokalDataD2 = tahun2D2["" + list.label];
                    lokalDataD2[LabelnyaTimeseries_2[list.id_bidang]] = convertToNumber(list.label_nilai);
                    tahun2D2["" + list.label] = lokalDataD2;
                  }
                }
              });
  ...
  function GrafikD1() {
    ...
    const disableYear = (year) => {
      return year < parseInt(selectedYearsTS) ? "cursor-not-allowed opacity-50" : "";
    };
    const disableYear2 = (year) => {
      return year > parseInt(selectedYearsTS2) ? "cursor-not-allowed opacity-50" : "";
    };
    var lebarnyaGrafik;
      ...
      <section>
        <div className="flex mt-[30px] mx-auto items-center justify-center">
          <div className="relative cursor-pointer w-[120px] font-medium text-[14px] text-secondary">
            <div onClick={() => setOpenYearsTS(!openYearsTS)} className="bg-[#ebebeb] w-full p-2 px-[30px] flex items-center justify-between rounded-[10px]">
              {selectedYearsTS ? selectedYearsTS : "Tahun"}
              <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-auto w-[10px] h-[20px] ${openYearsTS && "rotate-180"}`} />
            </div>
            {openYearsTS && (
              <div className="absolute z-10 bg-[#ebebeb] rounded-md shadow-lg w-full top-[45px] text-center">
                ...
                >
                  {years.map((yearData) => (
                    <li
                      key={yearData.tahun}
                      className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] ${disableYear2(yearData.tahun) ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`}
                      onClick={() => {
          ...
          <div className="relative cursor-pointer w-[120px] font-medium text-[14px] text-secondary">
            <div onClick={() => setOpenYearsTS2(!openYearsTS2)} className="bg-[#ebebeb] w-full p-2 px-[30px] flex items-center justify-between rounded-[10px]">
              {selectedYearsTS2 ? selectedYearsTS2 : "Tahun"}
              <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-auto w-[10px] h-[20px] ${openYearsTS2 && "rotate-180"}`} />
            </div>
            {openYearsTS2 && (
              <div className="absolute z-10 bg-[#ebebeb] rounded-md shadow-lg w-full top-[45px] text-center">
                <ul
                ...
                >
                  {years.map((yearData) => (
                    <li
                      key={yearData.tahun}
                      className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] ${disableYear(yearData.tahun) ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`}
                      onClick={() => {
        ...
        <div className="flex justify-center items-center text-secondary mt-4 gap-x-[80px]">
          <div className="text-center mt-[10px]">
            <>
              <p className="text-center font-bold text-[24px] text-secondary  lg:block md:block hidden">{sessionStorage.getItem("namaFilter1Berkaca")}</p>
              <p className="lg:text-[18px] text-[16px] lg:block md:block hidden italic">{kapitaset1}</p>
            </>
          </div>
        </div>
        <div className="grid flex grid-cols-1 sm:grid-cols-1 xl:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-x-4 gap-y-4 sm:gap-x-4 sm:gap-y-4 md:gap-x-8 md:gap-y-8 xl:gap-x-8 xl:gap-y-8 lg:gap-x-8 lg:gap-y-8 mt-8 lg:mt-16 mt-[50px]">
          <div className="flex flex-col bg-white w-[auto] xl:w-[650px] lg:w-[460px] md:w-[350px] sm:w-[400px] lg:ml-[0px] md:ml-[0px] xl:ml-[0px] sm:ml-[30px] ml-[0px] h-[auto] rounded-[10px] text-secondary border-1 border-[f1f1f1] text-[14px] font-medium items-center justify-center drop-shadow-lg mb-[20px]">
            <div className="flex flex-col items-center justify-center lg:h-full lg:mt-[10px] md:mt-[20px] mt-[20px]">
              <div className="w-[380px] xl:w-[600px] lg:w-[400px] md:w-[340px]  h-auto lg:mt-[20px] mx-4 lg:mx-[20px] overflow-x-scroll mini-scrollbar">
                {dataChart && dataChart.length > 0 && (
                  <LineChart data={dataChart} width={lebarnyaGrafik} height={isMobile ? 350 : 450} margin={{ bottom: marginBottom, top: marginTop }}>
                    <XAxis dataKey="label" tick={{ fontSize: 12 }} />
                    <YAxis />
                    <CartesianGrid strokeDasharray="0" />
                    <Tooltip content={<CustomTooltip />} />
                    {LabelnyaTimeseries_1.filter((grafiknya) => grafiknya !== null).map((grafiknya, index) => (
                      <Line strokeWidth={3} type="monotone" dataKey={grafiknya} stroke={TSCOLOR[index]} fillOpacity={1} fill={TSCOLOR[index]} layout="vertical" dot={{ r: 3 }} />
                    ))}
            ...
            <div
              className={`grid ${
                LabelnyaTimeseries_1.filter((grafiknya) => grafiknya !== null).length === 1
                  ? "grid-cols-1 gap-x-[0px] max-w-[500px] justify-center items-center lg:mt-[30px]"
                  : LabelnyaTimeseries_1.filter((grafiknya) => grafiknya !== null).length === 2
                  ? "grid-cols-2 gap-x-[10px] ml-[30px] mt-[30px]"
                  : LabelnyaTimeseries_1.filter((grafiknya) => grafiknya !== null).length > 3
            ...
            >
              {LabelnyaTimeseries_1.filter((grafiknya) => grafiknya !== null)
                .slice(null, lihatLegend ? LabelnyaTimeseries_1.length : maksimalTampil)
                .map((grafiknya, index) => (
                  <div className="flex items-center gap-x-2 w-auto" key={index}>
                    ...
                    ></div>
                    <p className="lg:text-[14px] text-[12px] w-full">{grafiknya}</p>
                  </div>
                ))}
              <div className="flex justify-center text-center items-start lg:mt-[10px] md:mt-[10px] mt-[10px] bg-white lg:h-[60px] h-[auto] col-span-3 lg:text-[14px] text-[12px] lg:mb-[0px] mb-[20px]">
                {!lihatLegend && LabelnyaTimeseries_1.filter((grafiknya) => grafiknya !== null).length > 3 && (
                  <button className="text-[#064878] hover:text-[#0B578E] focus:outline-none cursor-pointer" onClick={toggleLihatLengkap}>
          ...
          {/* DATASET1 DAERAH 2 */}
          <div
            className={`flex flex-col bg-white w-[auto] xl:w-[650px] lg:w-[460px] md:w-[350px] sm:w-[400px] h-[auto] rounded-[10px] text-secondary border-1 border-[f1f1f1] text-[14px] font-medium items-center justify-center drop-shadow-lg mb-[20px] sm:ml-[30px] xl:ml-[0px] lg:ml-[0px] md:ml-[0px] ${
              !showCards ? "hidden" : ""
            }`}
          >
            <div className="flex flex-col items-center justify-center lg:h-full lg:mt-[10px] md:mt-[20px] mt-[20px]">
              <div className="w-[380px] xl:w-[600px] lg:w-[400px] md:w-[340px]  h-auto lg:mt-[20px] mx-4 lg:mx-[20px] overflow-x-scroll mini-scrollbar">
                {dataChartd2 && dataChartd2.length > 0 && (
                  <LineChart data={dataChartd2} width={lebarnyaGrafik} height={isMobile ? 350 : 450} margin={{ bottom: marginBottom, top: marginTop }}>
                    <XAxis dataKey="label" tick={{ fontSize: 12 }} />
                    <YAxis />
                    <CartesianGrid strokeDasharray="0" />
                    <Tooltip content={<CustomTooltip />} />
                    {LabelnyaTimeseries_1.filter((grafiknyaD2) => grafiknyaD2 !== null).map((grafiknyaD2, index) => (
                      <Line strokeWidth={3} type="monotone" dataKey={grafiknyaD2} stroke={TSCOLOR[index]} fillOpacity={1} fill={TSCOLOR[index]} layout="vertical" dot={{ r: 3 }} />
                    ))}
            ...
            <div
              className={`grid ${
                LabelnyaTimeseries_1.filter((grafiknyaD2) => grafiknyaD2 !== null).length === 1
                  ? "grid-cols-1 gap-x-[0px] max-w-[500px] justify-center items-center lg:mt-[30px]"
                  : LabelnyaTimeseries_1.filter((grafiknyaD2) => grafiknyaD2 !== null).length === 2
                  ? "grid-cols-2 gap-x-[10px] ml-[30px] mt-[30px]"
                  : LabelnyaTimeseries_1.filter((grafiknyaD2) => grafiknyaD2 !== null).length > 3
                  ? "grid-cols-2 md:w-[300px] xl:w-[500px] lg:w-[300px] sm:w-[290px] w-[320px] justify-center items-center mt-[30px] gap-x-[6px]"
                  : ""
              }`}
            >
              {LabelnyaTimeseries_1.filter((grafiknyaD2) => grafiknyaD2 !== null)
                .slice(null, lihatLegendD2 ? LabelnyaTimeseries_1.length : maksimalTampilD2)
                .map((grafiknyaD2, index) => (
                  <div className="flex items-center gap-x-2 w-auto" key={index}>
                    ...
                    ></div>
                    <p className="lg:text-[14px] text-[12px] w-full">{grafiknyaD2}</p>
                  </div>
                ))}
              <div className="flex justify-center text-center items-start lg:mt-[10px] md:mt-[10px] mt-[10px] bg-white lg:h-[60px] h-[auto] col-span-3 lg:text-[14px] text-[12px] lg:mb-[0px] mb-[20px]">
                {!lihatLegendD2 && LabelnyaTimeseries_1.filter((grafiknyaD2) => grafiknyaD2 !== null).length > 3 && (
                  <button className="text-[#064878] hover:text-[#0B578E] focus:outline-none cursor-pointer" onClick={toggleLihatLengkapD2}>
                    Tampilkan Semua Legenda
                  </button>
                )}
              </div>
        ...
        <div className="text-center mt-[40px]">
          <>
            <p className="text-center font-extrabold text-[24px] text-secondary  lg:block md:block hidden">{sessionStorage.getItem("namaFilter2Berkaca")}</p>
            <p className="lg:text-[18px] text-[16px] lg:block md:block hidden italic">{kapitaset2}</p>
          </>
        </div>
        ...
        <div className="grid flex grid-cols-1 sm:grid-cols-1 xl:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-x-4 gap-y-4 sm:gap-x-4 sm:gap-y-4 md:gap-x-8 md:gap-y-8 xl:gap-x-8 xl:gap-y-8 lg:gap-x-8 lg:gap-y-8 mt-8 lg:mt-16 mt-[50px]">
          <div className="flex flex-col bg-white w-[auto] xl:w-[650px] lg:w-[460px] md:w-[350px] sm:w-[400px] lg:ml-[0px] md:ml-[0px] xl:ml-[0px] sm:ml-[30px] ml-[0px] h-[auto] rounded-[10px] text-secondary border-1 border-[f1f1f1] text-[14px] font-medium items-center justify-center drop-shadow-lg mb-[20px]">
            <div className="flex flex-col items-center justify-center lg:h-full lg:mt-[10px] md:mt-[20px] mt-[20px]">
              <div className="w-[380px] xl:w-[600px] lg:w-[400px] md:w-[340px]  h-auto lg:mt-[20px] mx-4 lg:mx-[20px] overflow-x-scroll mini-scrollbar">
                {dataChart2 && dataChart2.length > 0 && (
                  <LineChart data={dataChart2} width={lebarnyaGrafik} height={isMobile ? 350 : 450} margin={{ bottom: marginBottom, top: marginTop }}>
                    <XAxis dataKey="label" tick={{ fontSize: 12 }} />
                    <YAxis />
                    <CartesianGrid strokeDasharray="0" />
                    <Tooltip content={<CustomTooltip />} />
                    {LabelnyaTimeseries_2.filter((grafiknya) => grafiknya !== null).map((grafiknya, index) => (
                      <Line strokeWidth={3} type="monotone" dataKey={grafiknya} stroke={TSCOLOR2[index]} fillOpacity={1} fill={TSCOLOR2[index]} layout="vertical" dot={{ r: 3 }} />
                    ))}
                    <Legend
                      iconType="circle"
                      layout="horizontal"
            ...
            <div
              className={`grid ${
                LabelnyaTimeseries_2.filter((grafiknya) => grafiknya !== null).length === 1
                  ? "grid-cols-1 gap-x-[0px] max-w-[500px] justify-center items-center lg:mt-[30px]"
                  : LabelnyaTimeseries_2.filter((grafiknya) => grafiknya !== null).length === 2
                  ? "grid-cols-2 gap-x-[10px] ml-[30px] mt-[30px]"
                  : LabelnyaTimeseries_2.filter((grafiknya) => grafiknya !== null).length > 3
                  ? "grid-cols-2 md:w-[300px] xl:w-[500px] lg:w-[300px] sm:w-[290px] w-[320px] justify-center items-center mt-[30px] gap-x-[6px]"
                  : ""
              }`}
            >
              {LabelnyaTimeseries_2.filter((grafiknya) => grafiknya !== null)
                .slice(null, lihatLegend2 ? LabelnyaTimeseries_2.length : maksimalTampil)
                .map((grafiknya, index) => (
                  <div className="flex items-center gap-x-2 w-auto" key={index}>
                    <div
                      className="w-[16px] h-[13px] rounded-full"
                    ...
                    ></div>
                    <p className="lg:text-[14px] text-[12px] sm:text-[12px] w-full">{grafiknya}</p>
                  </div>
                ))}
              <div className="flex justify-center text-center items-start lg:mt-[10px] md:mt-[10px] mt-[10px] bg-white lg:h-[60px] h-[auto] col-span-3 lg:text-[14px] text-[12px] lg:mb-[0px] mb-[20px]">
                {!lihatLegend2 && LabelnyaTimeseries_2.filter((grafiknya) => grafiknya !== null).length > 3 && (
                  <button className="text-[#064878] hover:text-[#0B578E] focus:outline-none cursor-pointer" onClick={toggleLihatLengkap2}>
                    Tampilkan Semua Legenda
                  </button>
                )}
              </div>
          ...
          >
            <div className="flex flex-col items-center justify-center lg:h-full lg:mt-[10px] md:mt-[20px] mt-[20px]">
              <div className="w-[380px] xl:w-[600px] lg:w-[400px] md:w-[340px]  h-auto lg:mt-[20px] mx-4 lg:mx-[20px] overflow-x-scroll mini-scrollbar">
                {dataChart2 && dataChart2d2.length > 0 && (
                  <LineChart data={dataChart2d2} width={lebarnyaGrafik} height={isMobile ? 350 : 450} margin={{ bottom: marginBottom, top: marginTop }}>
                    <XAxis dataKey="label" tick={{ fontSize: 12 }} />
                    <YAxis />
                    <CartesianGrid strokeDasharray="0" />
                    <Tooltip content={<CustomTooltip />} />
                    {LabelnyaTimeseries_2.filter((grafiknyaD2) => grafiknyaD2 !== null).map((grafiknyaD2, index) => (
                      <Line strokeWidth={3} type="monotone" dataKey={grafiknyaD2} stroke={TSCOLOR2[index]} fillOpacity={1} fill={TSCOLOR2[index]} layout="vertical" dot={{ r: 3 }} />
                    ))}
                    <Legend
                      iconType="circle"
                      layout="horizontal"
            ...
            <div
              className={`grid ${
                LabelnyaTimeseries_2.filter((grafiknyaD2) => grafiknyaD2 !== null).length === 1
                  ? "grid-cols-1 gap-x-[0px] max-w-[500px] justify-center items-center lg:mt-[30px]"
                  : LabelnyaTimeseries_2.filter((grafiknyaD2) => grafiknyaD2 !== null).length === 2
                  ? "grid-cols-2 gap-x-[10px] ml-[30px] mt-[30px]"
                  : LabelnyaTimeseries_2.filter((grafiknyaD2) => grafiknyaD2 !== null).length > 3
                  ? "grid-cols-2 md:w-[300px] xl:w-[500px] lg:w-[300px] sm:w-[290px] w-[320px] justify-center items-center mt-[30px] gap-x-[6px]"
                  : ""
              }`}
            >
              {LabelnyaTimeseries_2.filter((grafiknyaD2) => grafiknyaD2 !== null)
                .slice(null, lihatLegend2D2 ? LabelnyaTimeseries_2.length : maksimalTampilD2)
                .map((grafiknyaD2, index) => (
                  <div className="flex items-center gap-x-2 w-auto" key={index}>
                    <div
                      className="w-[16px] h-[13px] rounded-full"
                    ...
                    ></div>
                    <p className="lg:text-[14px] text-[12px] sm:text-[12px] w-full">{grafiknyaD2}</p>
                  </div>
                ))}
              <div className="flex justify-center text-center items-start lg:mt-[10px] md:mt-[10px] mt-[10px] bg-white lg:h-[60px] h-[auto] col-span-3 lg:text-[14px] text-[12px] lg:mb-[0px] mb-[20px]">
                {!lihatLegend2D2 && LabelnyaTimeseries_2.filter((grafiknyaD2) => grafiknyaD2 !== null).length > 3 && (
                  <button className="text-[#064878] hover:text-[#0B578E] focus:outline-none cursor-pointer" onClick={toggleLihatLengkap2D2}>
                    Tampilkan Semua Legenda
                  </button>
                )}
              </div>
    ...
    return (
      <section>
        <div className="grid flex grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-4 md:gap-x-8 md:gap-y-8 mt-8 sm:mt-16 mt-[50px] sm:ml-[190px]">
          <div className={activeTabMobileDataset === "dataset1" ? "" : "hidden"}>
            <div
              className={`flex flex-col bg-white w-[350px] lg:w-[650px] lg:ml-[0px] ml-[2px] lg:h-[auto] h-[auto] rounded-[10px] text-secondary border-1 border-[f1f1f1] text-[14px] font-medium items-center justify-center drop-shadow-lg md:ml-[5px] ${
                !showCards ? "hidden" : ""
              }`}
            >
              <div className="flex flex-col items-center justify-center lg:h-full">
      ...
      BERKACA
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 lg:gap-x-[100px] lg:gap-y-[10px] md:gap-x-[50px] md:gap-y-[10px]">
          ...
          <div className="relative lg:w-[250px] md:w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer lg:block md:block hidden">
            ...
            >
              {selectedDaerah1 ? (selectedDaerah1?.length > 20 ? selectedDaerah1?.substring(0, 20) + "..." : selectedDaerah1) : "Provinsi"}
              <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-[20px] w-[10px] h-[20px] ${openProvinsiDaerah1 && "rotate-180"}`} />
            </div>
            <div
            ...
            >
              ...
              <input
                ...
                onChange={(e) => setInputValueDaerah1(e.target.value.toLowerCase())}
              ...
              {provincessDaerah1?.map((provinces) => (
                <li
                  ...
                  className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] 
                    ${provinces?.nama?.toLowerCase() === selectedDaerah1?.toLowerCase() && "bg-secondary text-white"}
                    ${provinces?.nama?.toLowerCase().includes(inputValueDaerah1) ? "block" : "hidden"}`}
                  onClick={() => {
                    updateKotaDaerah1(provinces?.nama, selectedDaerah1, provinces.id);
          ...
          <div className="relative lg:w-[250px] md:w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer lg:block md:block hidden">
            <div
              ...
              className="bg-[#ebebeb] w-full p-2 px-[30px] flex items-center justify-between rounded-[10px]"
            >
              {selectedCityDaerah1 ? (selectedCityDaerah1?.length > 20 ? selectedCityDaerah1?.substring(0, 20) + "..." : selectedCityDaerah1) : "Kota/Kabupaten"}
              <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-[20px] w-[10px] h-[20px] ${openCityDaerah1 && "rotate-180"}`} />
            </div>
            <div
              className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
            ...
            >
              ...
              <input
                ...
                onChange={(e) => setInputValueofCityDaerah1(e.target.value.toLowerCase())}
            ...
            >
              <li
                className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] text-secondary
                    ${"semua" === selectedCityDaerah1?.toLowerCase() && "bg-secondary text-white"}
                    `}
                onClick={() => {
                  setWilayahIDDaerahSATU("Semua");
                  sessionStorage.setItem("namawilayah", "Semua");
              ...
              {citiesDaerah1?.map((regencies) => (
                <li
                  key={regencies?.nama}
                  className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] 
                    ${regencies?.nama?.toLowerCase() === selectedCityDaerah1?.toLowerCase() && "bg-secondary text-white"}
                    ${regencies?.nama?.toLowerCase().includes(inputValueofCityDaerah1) ? "block" : "hidden"}`}
                  onClick={() => {
                    if (regencies?.nama?.toLowerCase() !== selectedCityDaerah1.toLowerCase()) {
          ...
          <div className="relative lg:w-[250px] md:w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer lg:block md:block hidden">
            <div
              ...
              className="bg-[#ebebeb] w-full p-2 px-[30px] flex items-center justify-between rounded-[10px]"
            >
              {selectedDaerah2 ? (selectedDaerah2?.length > 20 ? selectedDaerah2?.substring(0, 20) + "..." : selectedDaerah2) : "Provinsi"}
              <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-[20px] w-[10px] h-[20px] ${openProvinsiDaerah2 && "rotate-180"}`} />
            </div>
            <div
              className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
            ...
            >
              ...
              <input
                ...
                onChange={(e) => setInputValueDaerah2(e.target.value.toLowerCase())}
                placeholder="Cari Provinsi"
                className="text-secondary placeholder:text-opacity-75 p-2 outline-none w-full text-[12px] font-medium bg-[#ebebeb]"
              />
            </div>
            ...
            >
              {provincessDaerah2?.map((provinces2) => (
                <li
                  key={provinces2?.nama}
                  className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] 
                    ${provinces2?.nama?.toLowerCase() === selectedDaerah2?.toLowerCase() && "bg-secondary text-white"}
                    ${provinces2?.nama?.toLowerCase().includes(inputValueDaerah2) ? "block" : "hidden"}`}
                  onClick={() => {
                    updateKotaDaerah2(provinces2?.nama, selectedDaerah2, provinces2.id);
          ...
          <div className="relative lg:w-[250px] md:w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer lg:block md:block hidden">
            <div
              ...
              className="bg-[#ebebeb] w-full p-2 px-[30px] flex items-center justify-between rounded-[10px]"
            >
              {selectedCityDaerah2 ? (selectedCityDaerah2?.length > 20 ? selectedCityDaerah2?.substring(0, 20) + "..." : selectedCityDaerah2) : "Kota/Kabupaten"}
              <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-[20px] w-[10px] h-[20px] ${openCityDaerah2 && "rotate-180"}`} />
            </div>
            <div
              className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
            ...
            >
              ...
              <input
                ...
                onChange={(e) => setInputValueofCityDaerah2(e.target.value.toLowerCase())}
                placeholder="Cari Kota/Kabupaten"
                className="text-secondary placeholder:text-opacity-75 p-2 outline-none w-full text-[12px] font-medium bg-[#ebebeb]"
              />
            </div>
            ...
            >
              {selectedCityDaerah1 === "Semua" ? (
                <>
                  ...
                  <li
                    className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] text-secondary
                    ${"semua" === selectedCityDaerah2?.toLowerCase() && "bg-secondary text-white"}
                    `}
                    onClick={() => {
                      // setWilayahIDDaerahDUA("Semua");
                      setSelectedCityDaerah2("Semua");
                      ...
                      sessionStorage.setItem("infoProvinsi2", getInfoProvinsiDaerah2);
                    }}
                  >
                    Semua
                  </li>
              ...
              {citiesDaerah2?.map((regencies2) => (
                <li
                  key={regencies2?.nama}
                  className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] 
                    ${regencies2?.nama?.toLowerCase() === selectedCityDaerah2?.toLowerCase() && "bg-secondary text-white"}
                    ${regencies2?.nama?.toLowerCase().includes(inputValueofCityDaerah2) ? "block" : "hidden"}`}
                  onClick={() => {
                    if (selectedCityDaerah1 === "Semua") {
                      setSelectedCityDaerah2("Semua");
                      return;
                    }
                    if (regencies2?.nama?.toLowerCase() !== selectedCityDaerah2.toLowerCase()) {
                  ...
                  style={{
                    color: selectedCityDaerah1 === "Semua" && regencies2?.nama !== "Semua" ? "gray" : null,
                  }}
          ...
          <div className="flex flex-col justify-center items-center  ">
            <div className="relative mt-4 lg:block md:block hidden">
              <NavLink
                ...
                hover:text-white"
                onClick={(e) => {
                  if (selectedCityDaerah1.toLowerCase() !== "semua" && selectedCityDaerah2.toLowerCase() === "semua") {
                    Swal.fire({
                      title: "Perhatian!",
        ...
        <div id="timeseriesnyaaaaaaa2">
          <div className="flex flex-col justify-center items-center  ">
            ...
            <div className="flex mt-[30px] mx-auto items-center justify-center lg:hidden md:hidden">
              <div className="relative cursor-pointer w-[120px] font-medium text-[14px] text-secondary ">
                <div onClick={() => setOpenYearsTS(!openYearsTS)} className="bg-[#ebebeb] w-full h-[41px] text-[12px] p-2 px-[30px] flex items-center justify-between rounded-[10px]">
                  {selectedYearsTS ? selectedYearsTS : "Tahun"}
                  <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-auto w-[10px] h-[20px] ${openYearsTS && "rotate-180"}`} />
                </div>
                {openYearsTS && (
              ...
              <p className="text-secondary mx-[20px]">s/d</p>
              <div className="relative cursor-pointer w-[120px] font-medium text-[14px] text-secondary">
                <div onClick={() => setOpenYearsTS2(!openYearsTS2)} className="bg-[#ebebeb] w-full h-[41px] text-[12px] p-2 px-[30px] flex items-center justify-between rounded-[10px]">
                  {selectedYearsTS2 ? selectedYearsTS2 : "Tahun"}
                  <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-auto w-[10px] h-[20px] ${openYearsTS2 && "rotate-180"}`} />
                </div>
                {openYearsTS2 && (
            ...
            <div className={activeTabMobileDataset === "dataset1" ? "" : "hidden"}>
              <div className="flex justify-center items-center text-secondary  mt-4 gap-x-[80px]">
                <div className="text-center mt-[10px]">
                  <>
                    <p className="text-center font-bold text-[24px] text-secondary lg:hidden md:hidden ">{sessionStorage.getItem("namaFilter1Berkaca")}</p>
            ...
            <div className={activeTabMobileDataset === "dataset2" ? "" : "hidden"}>
              <div className="flex justify-center items-center text-secondary  mt-4 gap-x-[80px]">
                <div className="text-center mt-[10px]">
                  <>
                    <p className="text-center font-bold text-[24px] text-secondary ">{sessionStorage.getItem("namaFilter2Berkaca")}</p>
            ...
            <div className="flex gap-x-[20px] gap-y-[10px] mt-[50px] lg:hidden md:hidden">
              <div className="relative w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer lg:hidden md:hidden">
                ...
                >
                  ...
                  >
                    {selectedDaerah1 ? (selectedDaerah1?.length > 10 ? selectedDaerah1?.substring(0, 10) + "..." : selectedDaerah1) : "Provinsi"}
                  </span>
                  <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`absolute right-2 top-2 w-[10px] h-[20px] ${openProvinsiDaerah1 && "rotate-180"}`} />
                </div>
                <div
                  className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
                ${openProvinsiDaerah1 ? "max-h-auto" : "hidden"}`}
              ...
              <div className="relative w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer lg:hidden md:hidden">
                ...
                >
                  ...
                  >
                    {selectedCityDaerah1 ? (selectedCityDaerah1?.length > 10 ? selectedCityDaerah1?.substring(0, 10) + "..." : selectedCityDaerah1) : "Kota/Kabupaten"}
                  </span>
                  <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`absolute right-2 top-2 w-[10px] h-[20px] ${openCityDaerah1 && "rotate-180"}`} />
                </div>
                <div
                  className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
            ${openCityDaerah1 ? "max-h-auto" : "hidden"}`}
            ...
            <div className={activeTabMobileDataset === "dataset2" ? "" : "hidden"}>
              ...
              <div className=" text-center text-[14px] lg:text-[16px] mt-[10px] lg:hidden md:hidden"></div>
            </div>
            <div className="flex gap-x-[20px] gap-y-[10px] mt-[50px] lg:hidden md:hidden">
              <div className="relative w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer lg:hidden md:hidden">
                <div
                ...
                >
                  ...
                  >
                    {selectedDaerah2 ? (selectedDaerah2?.length > 10 ? selectedDaerah2?.substring(0, 10) + "..." : selectedDaerah2) : "Provinsi"}
                  </span>
                  <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`absolute right-2 top-2 w-[10px] h-[20px] ${openProvinsiDaerah2 && "rotate-180"}`} />
                </div>
                <div
                  className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
                ${openProvinsiDaerah2 ? "max-h-auto" : "hidden"}`}
              ...
              <div className="relative w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer lg:hidden md:hidden">
                ...
                >
                  ...
                  >
                    {selectedCityDaerah2 ? (selectedCityDaerah2?.length > 10 ? selectedCityDaerah2?.substring(0, 10) + "..." : selectedCityDaerah2) : "Kota/Kabupaten"}
                  </span>
                  <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`absolute right-2 top-2 w-[10px] h-[20px] ${openCityDaerah2 && "rotate-180"}`} />
                </div>
                <div
                  className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
            ${openCityDaerah2 ? "max-h-auto" : "hidden"}`}
            ...
            <div className={activeTabMobileDataset === "dataset1" ? "" : "hidden"}>
              <div className="text-center text-[14px] lg:text-[16px] mt-[10px] lg:hidden md:hidden">
                ...
                <p className="italic text-[#919BA2]">
                  Sumber: <br></br> {sumbernya1.length === 2 ? sumbernya1.join(" & ") : sumbernya1}
                </p>
              </div>
            </div>
            <div className={activeTabMobileDataset === "dataset2" ? "" : "hidden"}>
              ...
              <div className=" text-center text-[14px] lg:text-[16px] mt-[10px] lg:hidden md:hidden">
                ...
                <p className="italic text-[#919BA2]">
                  Sumber: <br></br> {sumbernya2.length === 2 ? sumbernya2.join(" & ") : sumbernya2}
                </p>
              </div>
            </div>
          </div>
          <div className="flex w-full h-[50px] items-center justify-center gap-[10px] md:gap-[20px] text-secondary">
            <div className="flex items-center gap-[10px]">
              ...
              <p className="text-[12px] md:text-[16px]">{view_info_halaman_timeseries} Lihat</p>
            </div>
            ...
            <div className="flex items-center gap-[10px]">
              ...
              <p className="text-[12px] md:text-[16px]">{simpan_info_halaman_timeseries} Simpan</p>
            </div>
            ...
            <button
              ...
              onClick={() => {
                if (tokenUser == null) {
                  ...
                  window.open(process.env.REACT_APP_URL_API + `/download-pdf?halaman=${halaman_timeseries}&id_member=${sessionStorage.getItem("member")}`);
                }
              }}
            >
              <FontAwesomeIcon icon={faDownload} color="#24445A" />
            </button>
            <div className="w-[30px] h-[30px] md:w-[40px] md:h-[40px]  rounded-md bg-primary drop-shadow-lg flex justify-center items-center hover:bg-third cursor-pointer" onClick={() => shareBtn(halaman_timeseries)}>
        ...
        <Modal isOpen={isModalOpen}>
          ...
          <div className="flex flex-row justify-between items-center xl:gap-[20px]">
            <div className="relative xl:w-[300px] lg:w-[200px] md:w-[200px] w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer">
              ...
              >
                {selectedDaerah2 ? (selectedDaerah2?.length > 20 ? selectedDaerah2?.substring(0, 20) + "..." : selectedDaerah2) : "Provinsi"}
                <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-[20px] w-[10px] h-[20px] ${openProvinsiDaerah2Modal && "rotate-180"}`} />
              </div>
              <div
                className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
            ...
            <div className="relative xl:w-[300px] lg:w-[200px] md:w-[200px] w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer">
              ...
              >
                {selectedCityDaerah2 ? (selectedCityDaerah2?.length > 20 ? selectedCityDaerah2?.substring(0, 20) + "..." : selectedCityDaerah2) : "Kota/Kabupaten"}
                <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-[20px] w-[10px] h-[20px] ${openCityDaerah2Modal && "rotate-180"}`} />
              </div>
              <div
                className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
        ...
        <Modal2 isOpen2={isModalOpen2}>
          ...
          <div className="flex flex-row justify-between items-center xl:gap-[20px]">
            ...
            <div className="relative xl:w-[300px] lg:w-[200px] md:w-[200px] w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer">
              ...
              >
                {selectedDaerah1 ? (selectedDaerah1?.length > 20 ? selectedDaerah1?.substring(0, 20) + "..." : selectedDaerah1) : "Provinsi"}
                <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-[20px] w-[10px] h-[20px] ${openProvinsiDaerah1Modal && "rotate-180"}`} />
              </div>
              <div
                className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
            ...
            <div className="relative xl:w-[300px] lg:w-[200px] md:w-[200px] w-[150px] h-auto text-secondary font-medium text-[14px] cursor-pointer">
              ...
              >
                {selectedCityDaerah1 ? (selectedCityDaerah1?.length > 20 ? selectedCityDaerah1?.substring(0, 20) + "..." : selectedCityDaerah1) : "Kota/Kabupaten"}
                <FontAwesomeIcon icon={faChevronDown} color="#24445A" className={`ml-[20px] w-[10px] h-[20px] ${openCityDaerah1Modal && "rotate-180"}`} />
              </div>
              <div
                className={`flex items-center px-2 sticky top-0 bg-[#ebebeb] w-full mt-2 rounded-[10px]
              ...
              >
                ...
                {citiesDaerah1?.map((regencies) => (
                  <li
                    ...
                    style={{
                      color: (selectedCityDaerah2 === "Semua" && regencies?.nama !== "Semua") || regencies?.nama === "Semua" ? "gray" : null,
                    }}
              ...
              >
                {provincessDaerah2?.map((provinces2) => (
                  <li
                    ...
                    className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] 
                    ${provinces2?.nama?.toLowerCase() === selectedDaerah2?.toLowerCase() && "bg-secondary text-white"}
                    ${provinces2?.nama?.toLowerCase().startsWith(inputValueDaerah2) ? "block" : "hidden"}`}
                    onClick={() => {
                      updateKotaDaerah2(provinces2?.nama, selectedDaerah2, provinces2.id);
                      sessionStorage.setItem("idprovinsi_berkaca2", provinces2.id);
                      sessionStorage.setItem("namaprovinsi_berkaca2", provinces2.nama);
              ...
              >
                ...
                {citiesDaerah2?.map((regencies2) => (
                  <li
                    ...
                    className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] 
                    ${regencies2?.nama?.toLowerCase() === selectedCityDaerah2?.toLowerCase() && "bg-secondary text-white"}
                    ${regencies2?.nama?.toLowerCase().startsWith(inputValueofCityDaerah2) ? "block" : "hidden"}`}
                    onClick={() => {
                      // if (selectedCityDaerah1 === "Semua") {
                      //   setSelectedCityDaerah2("Semua");
                      //   return;
                    ...
                    style={{
                      color: (selectedCityDaerah1 === "Semua" && regencies2?.nama !== "Semua") || regencies2?.nama === "Semua" ? "gray" : null,
                    }}
              ...
              >
                {provincessDaerah1?.map((provinces) => (
                  <li
                    ...
                    className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] 
                    ${provinces?.nama?.toLowerCase() === selectedDaerah1?.toLowerCase() && "bg-secondary text-white"}
                    ${provinces?.nama?.toLowerCase().startsWith(inputValueDaerah1) ? "block" : "hidden"}`}
                    onClick={() => {
                      updateKotaDaerah1(provinces?.nama, selectedDaerah1, provinces.id);
                      sessionStorage.setItem("idprovinsi", provinces.id);
                      sessionStorage.setItem("idwilayah", provinces.id);
              ...
              >
                ...
                {citiesDaerah1?.map((regencies) => (
                  <li
                    ...
                    className={`p-2 text-[12px] hover:bg-third hover:text-white rounded-[10px] 
                    ${regencies?.nama?.toLowerCase() === selectedCityDaerah1?.toLowerCase() && "bg-secondary text-white"}
                    ${regencies?.nama?.toLowerCase().startsWith(inputValueofCityDaerah1) ? "block" : "hidden"}`}
                    onClick={() => {
                      if (regencies?.nama?.toLowerCase() !== selectedCityDaerah1.toLowerCase()) {
                        setWilayahIDDaerahSATU(regencies.id);
                        sessionStorage.setItem("namawilayah", regencies.nama);
