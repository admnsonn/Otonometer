...
const Jelajahprofil = () => {
  ...
  const [openWakilKetua, setOpenWakilKetua] = useState(false);
  const [openWakilKetua1, setOpenWakilKetua1] = useState(false);
  const [openWakilKetua2, setOpenWakilKetua2] = useState(false);
  const [openWakilKetua3, setOpenWakilKetua3] = useState(false);
  ...
  const SwitchBtn = ({ selected, onSelect }) => (
    <div className="switch" onClick={onSelect}>
      <input
        type="checkbox"
        id="toggle"
        checked={selected === "dprd" || selected === "sekretariatdprd"}
      />
  ...
  useEffect(() => {
    if (window.location.hash === "#scroll") {
      const element = document.getElementById("posisi");
      if (element) {
      ...
      .then((result) => {
        if (result.success === true) {
          if (result.data.ketua.length > 0 && result.data.wakil.length > 0) {
            ...
            result.data.ketua.length > 0 &&
            result.data.wakil.length === 0
          ) {
            setNamaketua(result.data.ketua[0].nama_lengkap);
            setTlketua(result.data.ketua[0].tahun_lantik);
            setTaketua(result.data.ketua[0].tahun_akhir);
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-[100px]">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-x-2 mt-2 md:mt-5 lg:mt-[50px]">
        <a
          href="/Dprdkedua"
          className="ml-2 mr-4 xl:mr-[485px] xl:ml-[60px] md:mt-0 lg:mb-7 relative"
        >
          <img
            src={back}
            alt=""
        ...
        <h1 className="text-secondary text-2xl text-center mt-5 mb-2 font-bold lg:text-4xl lg:mt-0 lg:mb-5 lg:mr-10 xl:mr-[600px] xl:ml-[-5px]">
          Info Daerah
        </h1>
      </div>
      {/* DROPDOWN */}
      ...
      <h1 className="text-center flex justify-center items-center text-secondary text-[20px] md:text-[34px] lg:text-[30px] xl:text-[30px] font-bold mt-[24px]">
        PEMERINTAH KOTA SUMEDANG
      </h1>

      <h1 className="text-center flex justify-center items-center text-secondary text-[20px] md:text-[34px] lg:text-[30px] xl:text-[30px] font-bold italic mt-[40px]">
        Pimpinan DPRD
      </h1>

      {/* DATA KETUA WAKIL KETUA */}
      <div className="flex max-w-[1200px] h-auto p-[29px] overflow-scroll gap-x-[45px] mt-[30px]">
        {/* Card 1 */}
        <div
          className={`flex items-center rounded-[50px] bg-white drop-shadow-[0_1px_15px_rgba(0,0,0,0.15)] w-auto ${
            openCard ? "animate-expand" : "animate-collapse"
          }`}
        >
          <div className="flex flex-col items-center w-[347px] h-[382px] rounded-[50px] bg-white py-[20px] px-[34px]">
            ...
            >
              <FontAwesomeIcon
                icon={faArrowRight}
                color="#24445A"
                className={`w-[21px] h-auto transition duration-200 ease-in ${
                  openCard ? "rotate-180" : ""
                }`}
              />
            </div>
          ...
          <div
            className={`${
              openCard ? "block animate-fadeIn" : "hidden"
            } transition duration-200 ease-in w-[347px] h-[382px] rounded-[50px] bg-white py-[20px] pr-[34px]`}
          >
            <div className="w-full h-full bg-[#EFEFEF] rounded-[15px] text-secondary text-[12px] p-[18px] overflow-auto mini-scrollbar">
              <p>
                Alamat Kantor : HVRW+M8W, Simbula, Kec. Katoi, Kabupaten Kolaka
                Utara, Sulawesi Tenggara 93957 Adasdasdsda asdasdasd jkkk asd
                asdasdasd
              </p>
      ...
      <div
        id="posisi"
        class="border-b-2 border-[#DADADA] w-[400px] xl:w-[1190px] lg:w-[900px] md:w-[700px] sm:w-[500px] mt-[50px] mb-[30px] relative"
      ></div>

      {/* DATA JAJARAN KOMISI I */}
      <h1 className="text-center flex justify-center items-center text-secondary text-[20px] md:text-[34px] lg:text-[30px] xl:text-[30px] font-bold italic mt-[20px]">
        Komisi I
      </h1>
      ...
      <div className="flex mt-[40px] space-x-10 relative">
        ...
        <button className="flex w-[100px] md:w-[167px] h-[40px] rounded-full border border-[#f1f1f1] text-[14px] font-bold items-center justify-center bg-third text-secondary">
          Kesehatan
        </button>
        <button className="flex w-[100px] md:w-[167px] h-[40px] rounded-full border border-[#f1f1f1] text-[14px] font-bold items-center justify-center bg-third text-secondary">
          Transportasi
      ...
      {isPilihVisible && (
        <>
          <button
            ...
            className="w-full sm:w-[250px] h-auto text-secondary font-medium text-[14px] cursor-pointer bg-[#ebebeb] p-2 sm:px-[30px] flex items-center justify-between rounded-[10px] mt-[30px]"
          >
          ...
          {isDropdownVisible && (
            <div className="dropdown bg-[#ebebeb] mt-2 rounded-[10px] w-full sm:w-[250px] h-auto overflow-y-auto text-[14px]">
              {options.map((option, index) => (
                <div
                  key={index}
                  onClick={() => handleOptionClickD(option)}
                  className="dropdown-option p-2 hover:bg-third hover:text-white rounded-[10px] cursor-pointer"
                >
                  {option}
                </div>
              ))}
