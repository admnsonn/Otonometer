      ...
      <div className="flex max-w-[1200px] h-auto p-[29px] overflow-scroll gap-x-[45px] mt-[30px]">
        ...
        >
          <div className="flex flex-col items-center w-[347px] h-[382px] rounded-[50px] bg-white py-[20px] px-[34px]">
            ...
            >
              <FontAwesomeIcon
                icon={openCard ? faArrowRight : faEllipsisV}
                color="#24445A"
                className={`transition duration-200 ease-in ${
                  openCard ? "w-[21px] h-auto rotate-180" : "w-[5px] h-auto"
                }`}
              />
            </div>
            {dropdownOpen && (
              <div
                ref={dropdownRef}
                className="absolute top-[50px] right-[-25px] w-[100px] bg-white border border-gray-200 rounded-md shadow-lg text-[14px]"
              >
                <div
                  className="px-4 py-2 cursor-pointer hover:bg-third hover:text-white rounded-[10px]"
                  onClick={() => {
                    setOpenCard(true);
                ...
                <div
                  className="px-4 py-2 cursor-pointer hover:bg-third hover:text-white rounded-[10px]"
                  onClick={() => {
                    window.location.href = "/Dprdlinimasa";
                    setDropdownOpen(false);
                  }}
                >
                  Lini Masa
