...
const EditProfileGoogle = () => {
  ...
  const locale = {
    ...
    const [hiddenBack, setHiddenBack] = useState(null)
    ...
    const validateName = (name) => {
      ...
      if (name.length > maxLength || words.length < minWords) {
        return `Jumlah huruf paling banyak ${maxLength} huruf termasuk spasi, dan jumlah kata paling sedikit ${minWords} kata.`;
      }
      return "";
    };
    ...
    useEffect(() => {
      var selectedTitle = formData.title
      setFormData((prevState) => ({
        ...prevState,
        title: selectedTitle,
      }));
    ...
    const handleImageChange = (event) => {
      ...
      reader.onloadend = () => {
        const base64String = reader.result.split(',')[1]; // Extract base64 string without the data:image/jpeg;base64, prefix
              ...
              if (response.data.status) {
                ...
                Swal.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    //   category: 'User',
                    //   action: 'Registration',
                    //   label: 'Regist With Google Account',
                    //   user_gender: gender,
                    ...
                    window.location.href = "/Buat-Kata-Sandi";
                  }
                });
              }
            } catch (error) {
    ...
    useEffect(()=>{
      if (formData.title === "" && formData.kondisiAwal === false){
        setGarisTitle(true)
      }else{
        setGarisTitle(false)
      }
    ...
    },[formData.city_id,formData.city_value])
    ...
    },[formData.postal_code,formData.address])
    ...
    return (
        <div className="flex flex-col md:flex-row h-screen">
            ...
            <div className="md:w-1/2 flex justify-center items-center">
                ...
                >
                <h1 className="text-center flex justify-center items-center text-secondary text-[30px] md:text-[34px] font-bold max-h-screen">
                    Lengkapi Data Diri
                </h1>
                {/* UPLOAD IMAGE */}
                ...
                <div className="absolute bg-white w-[30px] h-[30px] rounded-full hover:cursor-pointer translate-y-[89px]" style={{ top: "0", right: "0" }}>
                ...
                <div className="flex mb-[10px]">
                    ...
                    <div>
                        ...
                        {isOpenTitle && (
                        <div className="absolute mt-1 lg:w-[84px] w-[250px] bg-white border border-gray-300 rounded-md shadow-lg z-10 text-secondary">
                    ...
                    <div>
                        ...
                        {isOpen3 && (
                          <div className="relative w-full">
                            <div className="absolute mt-1 w-full bg-white border border-gray-300 rounded-md shadow-lg z-30">
                            <div className="flex items-center px-2 bg-[#ebebeb] w-full">
                            <FontAwesomeIcon
                                icon={faSearch}
                                color="#24445A"
