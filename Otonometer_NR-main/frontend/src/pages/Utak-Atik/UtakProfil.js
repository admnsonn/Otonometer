...
const Utakprofil = () => {
  // useEffect(()=>{
  //   ReactGA.send({ hitType: "pageview", page: window.location.pathname, title: "Profil Daerah via Utak-atik" });
  // },[])
  ...
  return (
    <div className="flex flex-col mb-[150px] justify-center items-center mt-[125px]">
      ...
      {/* <div className="flex gap-[250px]">
        <div className="flex-none w-14 h-14" onClick={goBackAndRestoreSession}> 
        ...
        <div className="flex bg-none w-[40px] h-[20px] items-center justify-center"></div>
      </div> */}
      {/* <div className="flex bg-none w-[167px] h-[41px] rounded-[10px] text-secondary border-2 border-secondary text-[14px] font-semibold items-center justify-center">
        UTAK-ATIK
      </div> */}
            ...
            {provincess?.map((provinces) => (
              <li
                ...
                onClick={() => {
                  ...
                  sessionStorage.setItem("Utakprofil_provinsi", provinces.id);
                  updatePejabat(
          ...
          >
            <li
              ...
              onClick={() => {
                ...
                updatePeta(sessionStorage.getItem("Utakprofil_provinsi"));
                setOpenCity(false);
                askIsProvince(true);
                updatePejabat(
                  sessionStorage.getItem("Utakprofil_provinsi"),
