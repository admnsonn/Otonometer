...
const PemdaAnakan2 = () => {
  ...
  const [icon, setIcon] = useState(tambah);

  const toggleAtasan = () => {
    setOpenAtasan(!openAtasan);
    setIcon(openAtasan ? tambah : minus);
  };
  ...
  return (
    <div className="flex flex-col mb-[150px] justify-center items-center mt-[125px]">
      ...
      <h1 className="text-center flex justify-center items-center text-secondary text-[20px] md:text-[34px] lg:text-[30px] xl:text-[30px] font-bold italic mt-[40px]">Atasan </h1>
      ...
      <h1 className="text-center flex justify-center items-center text-secondary text-[20px] md:text-[34px] lg:text-[30px] xl:text-[30px] font-bold italic mt-[10px]">Pejabat</h1>
      <div>
        <div className="mt-5 flex justify-center">
          <img src={icon} alt="" className="cursor-pointer" onClick={toggleAtasan} />
        </div>

        {openAtasan && (
          <div className={`flex items-center justify-center rounded-[50px] bg-white drop-shadow-[0_1px_15px_rgba(0,0,0,0.15)] w-auto ${openCard ? "animate-expand" : "animate-collapse"}`}>
            <div className="flex flex-col items-center w-[347px] h-[302px] rounded-[50px] bg-white py-[20px] px-[34px]">
              <div
                className="w-full flex justify-end cursor-pointer"
                onClick={() => {
      ...
      <div className="flex max-w-[1200px] h-auto p-[29px] gap-x-[45px] overflow-scroll mt-[30px]">
        ...
        <div className={`flex items-center rounded-[50px] bg-white drop-shadow-[0_1px_15px_rgba(0,0,0,0.15)] w-auto ${openCard ? "animate-expand" : "animate-collapse"}`}>
          <div className="flex flex-col items-center w-[347px] h-[302px] rounded-[50px] bg-white py-[20px] px-[34px]">
            ...
            <p className="w-full text-secondary text-[16px] text-center break-words font-bold mt-[11px]">Bambang Tirtoyuliono</p>
            <p className="w-full text-secondary text-[12px] text-center break-words font-regular">Asisten Perekonomian dan Pembangunan</p>
            <a href="https://wa.me/081296735155" className="w-full text-secondary text-[12px] text-center break-words font-regular">
              Masa Periode : 2019 - 2024
            </a>
            <a href="https://wa.me/081296735155" className="w-full text-secondary text-[12px] text-center break-words font-regular">
      ...
      <div className="flex max-w-[1200px] h-auto p-[29px] gap-x-[45px] overflow-scroll mt-[30px]">
        <h1 className="text-center flex justify-center items-center text-secondary text-[16px] md:text-[34px] lg:text-[16px] xl:text-[16px] font-bold italic mt-[10px]">Tidak Tersedia</h1>
        {/* Card 1 */}
      ...
      <div className="flex max-w-[1200px] h-auto p-[29px] gap-x-[45px] overflow-scroll mt-[30px]">
        ...
        <div className={`flex items-center rounded-[50px] bg-white drop-shadow-[0_1px_15px_rgba(0,0,0,0.15)] w-auto ${openCard ? "animate-expand" : "animate-collapse"}`}>
          <div className="flex flex-col items-center w-[347px] h-[302px] rounded-[50px] bg-white py-[20px] px-[34px]">
            ...
            <p className="w-full text-secondary text-[16px] text-center break-words font-bold mt-[11px]">Bambang Tirtoyuliono</p>
            <p className="w-full text-secondary text-[12px] text-center break-words font-regular">Kepala Bagian Administrasi Pembangunan</p>
            <a href="https://wa.me/081296735155" className="w-full text-secondary text-[12px] text-center break-words font-regular">
              Masa Periode : 2019 - 2024
            </a>
            <a href="https://wa.me/081296735155" className="w-full text-secondary text-[12px] text-center break-words font-regular">
