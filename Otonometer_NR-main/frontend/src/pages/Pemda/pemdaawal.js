...
import { faArrowRight, faCaretDown, faChevronDown, faSearch } from "@fortawesome/free-solid-svg-icons";
...
const PemdaAwal = () => {
  ...
  return (
    <div className="flex flex-col mb-[150px] justify-center items-center mt-[125px]">
      ...
      <img src={peta} alt="" className="flex items-center w-[200px] md:w-80 mb-[40px] mt-[20px]" />
      ...
      <div className="flex gap-[20px] mt-[20px] mb-[20px] lg:gap-[50px] items-center justify-center">
        ...
        <div className="text-[14px] md:text-[20px] text-secondary mt-[5px]">
          <p className="font-bold text-left">{Math.round(data_Penduduk).toLocaleString().replaceAll(/,/g, ".")}</p>
      ...
      <div className="flex items-center justify-center font-bold text-secondary mt-[48px] text-[16px] md:text-[20px]">
        <p>WALI KOTA</p>
      </div>
      {/* Card Pejabat */}
      <div className="flex max-w-[1189px] h-auto p-[29px] gap-x-[45px] overflow-scroll mt-[30px]">
        ...
        <div className={`flex items-center rounded-[50px] bg-white drop-shadow-[0_1px_15px_rgba(0,0,0,0.15)] w-auto ${openCard ? "animate-expand" : "animate-collapse"}`}>
          <div className="flex flex-col items-center w-[347px] h-[302px] rounded-[50px] bg-white py-[20px] px-[34px]">
            ...
            >
              <FontAwesomeIcon icon={faArrowRight} color="#24445A" className={`w-[21px] h-auto transition duration-200 ease-in ${openCard2 ? "rotate-180" : ""}`} />
            </div>
            <div className="w-full flex justify-center">
              <div className="relative w-[146px] h-[146px] bg-white rounded-full border-[5px] border-solid border-secondary">
                <img src={fotowalikota} alt="" className="absolute top-0 left-0 right-0 bottom-0 m-auto object-cover w-[128px] h-[128px] bg-secondary rounded-full border-[4px] border-solid border-secondary" />
      ...
      <div className="mt-[50px]">
        <a href="/PemdaLengkap" className="w-full text-secondary text-[20px] font-bold text-center break-words font-regular">
          Lihat Semua
        </a>
      </div>
    </div>
